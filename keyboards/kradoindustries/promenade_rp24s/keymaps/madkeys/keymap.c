...
#define LAYOUT_promenade_grid_wrapper(...) LAYOUT(__VA_ARGS__)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * |Ctl/Esc|  A  |   S  |   D  |   F  |   G  |      |      |   H  |   J  |   K  |   L  |;/NAV |'/Ctl |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * |Shift |   Z  |   X  |   C  |   V  |   B  | PgUp | PgDn |   N  |   M  |   ,  |   .  |   /  |Shift |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * | Ctrl | Adj  | GUI  |Alt/Ent|Lower| Space|Space |Space |Raise | RAlt | Left | Down |  Up  |Right |
     * `-------------------------------------------------------------------------------------------------'
     */
    [_BASE] = LAYOUT_promenade_grid_wrapper(
        ...
        KC_LCTL, MO(_ADJUST), KC_LGUI, MADLALTENT, LT(_LOWER, KC_SPC), KC_SPC, LT(_RAISE, KC_SPC), LT(_RAISE, KC_SPC), LT(_RAISE, KC_SPC), KC_RALT, KC_ENT, KC_RGUI, MO(_ADJUST),KC_LCTL
    ),
     ...
     * |  ~   |  F9  |  F10 |  F11 |  F12 |      |      |      |      |      |      |      |      |      |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * |  ~   |  F5  |  F6  |  F7  |  F8  |      |      |      | PgUp | Home |  Up  | End  |      | Del  |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * | Del  |  F1  |  F2  |  F3  |  F4  |      |      |      | PgDn | Left | Down |Right |      |      |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |      |      |      | BRK  |      |      |      |      |      |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |      |      |      | Adj  |      |      |      |      |      |
    ...
    /* Adjust Layer - RGB & Media Controls
     * ,-------------------------------------------------------------------------------------------------.
     * | XXX  |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  | F10  | F11  | F12  | Del  |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * | Make | Home |  Up  | End  | PgUp |      | Play | Stop |  Tog | Next | Spd- | Spd+ |PrtScr|      |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * | Boot | Left | Down |Right | PgDn |      |      |      | Hue+ | Sat+ | Val+ |Plain | Grad | Boot |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     ...
     * `-------------------------------------------------------------------------------------------------'
     */
    [_ADJUST] = LAYOUT_promenade_grid_wrapper(
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [0]       = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD),       ENCODER_CCW_CW(KC_F18, KC_F17),
