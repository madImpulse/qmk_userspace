 ...
 */
    [_GWSAD] = LAYOUT_elora_grid_wrapper(
      ...
      KC_LCTL , KC_LCTL,KC_Z ,  KC_X   ,  KC_C  ,   KC_V , KC_5  , KC_G   ,     FKEYS  , _______, KC_N ,  KC_M ,KC_COMM, KC_DOT ,KC_SLSH, KC_RSFT,
                                KC_ENT ,    KC_T, KC_SPC, KC_SPC, KC_SPC ,      KC_SPC    , KC_SPC ,KC_RALT, KC_RGUI, ADJUST,
